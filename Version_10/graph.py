...
def initialize():
    ...
    try:
        # NOTE: Ensure your database and Ollama services are running and accessible.
        ...
        # The error message will now be displayed in the sidebar, and None will be returned.
...
# --- 4. Prompt Chains ---
# --- CHANGE START: Defer chain creation until we know initialization succeeded ---
...
if st.button("Generate Report") and question:
    # This check now correctly prevents execution if initialization failed.
